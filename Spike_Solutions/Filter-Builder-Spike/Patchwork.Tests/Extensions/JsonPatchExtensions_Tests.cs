...
public class JsonPatchExtensions_Tests
{
  ...
  public void JsonPatchExtensions_ShouldSplitPatchById_WhenPatchHasMultipleOperationTypes()
  {
    ...
    IEnumerable<string> ME_9997Operations = output["ME_9997"].Operations.Select(a => { return a.Op.ToString(); });
    ...
    IEnumerable<string> ME_9998Operations = output["ME_9998"].Operations.Select(a => { return a.Op.ToString(); });
    ...
    IEnumerable<string> ME_9999Operations = output["ME_9999"].Operations.Select(a => { return a.Op.ToString(); });
