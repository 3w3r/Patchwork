...
CREATE TABLE classicmodels.products (
  ...
  productLine VARCHAR(50) NOT NULL REFERENCES classicmodels.productlines(productLine),
...
CREATE TABLE classicmodels.employees (
  ...
  officeCode VARCHAR(10) NOT NULL REFERENCES classicmodels.offices(officeCode),
  reportsTo INTEGER REFERENCES classicmodels.employees(employeeNumber),
...
CREATE TABLE classicmodels.customers (
  ...
  country VARCHAR(50) NOT NULL,
  salesRepEmployeeNumber INTEGER REFERENCES classicmodels.employees(employeeNumber),
...
CREATE TABLE classicmodels.orders (
  ...
  comments TEXT,
  customerNumber INTEGER NOT NULL REFERENCES classicmodels.customers(customerNumber)
);
...
-- Create views
CREATE VIEW classicmodels.customer_product_line_spending AS
SELECT
    c.contactFirstName,
    c.contactLastName,
    p.productLine,
...
insert  into classicmodels.products(productCode,productName,productLine,productScale,productVendor,productDescription,quantityInStock,buyPrice,MSRP) values 
...
insert  into classicmodels.offices(officeCode,city,phone,addressLine1,addressLine2,state,country,postalCode,territory) values 
...
insert  into classicmodels.employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values 
...
insert  into classicmodels.payments (customerNumber,checkNumber,paymentDate,amount) values 
...
insert  into classicmodels.orderdetails(orderNumber,productCode,quantityOrdered,priceEach,orderLineNumber) values 
